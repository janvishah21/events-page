...
class AuthenticationForm(forms.Form):
	...
	username = forms.CharField(label='Username', max_length=20, min_length=5, widget=forms.TextInput(attrs={'class': 'form-control'}))
	email = forms.EmailField(label='Email', max_length=40, min_length=5, widget=forms.EmailInput(attrs={'class': 'form-control'}))
